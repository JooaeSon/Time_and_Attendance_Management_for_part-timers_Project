...
function submit(){
	var inws_code= document.createElement('input');
// 	alert(ws_code);
	inws_code.type='hidden';
	inws_code.setAttribute('name','ws_code');
	inws_code.value='${WSDto.ws_code}';
	var form =document.getElementsByTagName('form')[0];
	form.appendChild(inws_code);
	form.submit();
}
...
<input type="hidden" name="user_id" value="${WSDto.user_id}">
	<table class="table table-bordered">
			<tr>
				<th>사업장 이름</th>
				<td>
				<input type="text" name="ws_name" id="ws_name" value="${WSDto.ws_name}">
				<span></span>
				</td>
			</tr>
			<tr>
				<th>사업장 주소</th>
				<td>
				<input type="text" name="ws_loc" id="ws_loc" value="${WSDto.ws_loc}"> 
				<span></span>
				<br>
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="ws_num2" id="ws_num" placeholder="- 를 제외한 값을 입력하세요" value="${WSDto.ws_num2}">
					<span></span>
				</td>
			</tr>
			<tr>
				<th>대표 이메일</th>
				<td>
					<input type="email" name="ws_email" id="ws_email" value="${WSDto.ws_email}">
					<span></span>
				</td>
			</tr>
			<tr>
				<th>WI-FI 이름</th>
				<td>
					<input type="text" name="ws_ssid" id="ws_ssid" value="${WSDto.ws_ssid}">
					<span></span>
				</td>
			</tr>
			<tr>
				<th>WI-FI IP</th>
				<td>
					<input type="text" name="ws_ip" id="ws_ip" placeholder=". 을 제외한 값을 입력하세요" value="${WSDto.ws_reip}">
					<span></span>
				</td>
			</tr>
			<tr>
				<th>사업장 </th>
				<td>
					<input type="text" name="ws_vol" id="ws_vol" value="${WSDto.ws_vol}">
					<span></span>
				</td>
			</tr>
		</table>
  ...
  <div style="text-align: center;">
				<input class="btn btn-basic" type="button" value="수정" onclick="submit()" >
			</div>
         </div>
      </div>
   </div>

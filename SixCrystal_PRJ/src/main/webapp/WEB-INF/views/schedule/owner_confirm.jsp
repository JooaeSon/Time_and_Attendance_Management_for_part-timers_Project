...
<script type="text/javascript">
    ...
    function doExcelDownloadProcess(){
        ...
        confirm("저장된 직원과 매니저의 근무일정을 엑셀형태로 다운로드 하시겠습니까?","");
...
<div class="container-fluid-full">
   <div class="row-fluid">
      ...
      <div id="content" class="span10" style="min-height: 800px; margin: auto; padding: 0px;"> 
    <div id="lnb"  style="width: 170px;">
        <div id="lnb-calendars" class="lnb-calendars">
           ...
           <input type="checkbox" id='reviseable'>&nbsp;&nbsp;&nbsp;직원 수정가능 여부
           <button onclick="saveScheduleByOwner()" style='margin-right: 10px; width:110px;' class="btn btn-default btn-sm dropdown-toggle" 
           type="button">저장</button><hr>
<form id="form1" name="form1" method="post" enctype="multipart/form-data">
    <button class="btn btn-default btn-sm dropdown-toggle" type="button" type="button" onclick="doExcelDownloadProcess()">엑셀다운로드</button><br>
</form>
    </div>
    <div id="right">
        <div id="menu">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <script src="././Schedule_src/js/owner_confirm.js"></script>
